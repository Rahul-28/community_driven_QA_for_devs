...
{(
  () => {
    ...
    <div style={{ display: 'inline-flex', justifyContent: 'center', alignItems: 'center',padding: '80px 0px 50px 190px'}}>
              ...
              <Grid>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body1" style={{ marginTop: '20px' }}>
                    Don't have an account? <NavLink to="/register">Signup Now</NavLink>
                  </Typography>
                </form>
                </Grid>
              </Paper>
