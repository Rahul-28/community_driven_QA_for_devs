...
function Register() {
  ...
  return (
      ...
      <div style={{ display: 'inline-flex', justifyContent: 'center', alignItems: 'center',padding: '60px 0px 50px 120px'}}>
         <Paper elevation={3} style={{ padding: '100px', alignItems: 'center',background:"#721d8a" }}>
            <Grid>
                <img src={StackOverflowLogo} alt="Stack Overflow Logo" style={{ width: '190px',height: '40px' ,alignItems:'center' }} />
            </Grid>
        <Typography variant="h4" style={{ textAlign: 'center', marginBottom: '20px' }}>Create an account</Typography>
        <Paper style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }} elevation={3}>
        ...
        {state && (
          <div className="alert alert-success" role="alert" style={{ textAlign: 'center', marginTop: '20px' }}>
